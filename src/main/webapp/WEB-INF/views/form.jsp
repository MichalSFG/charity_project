...
<header class="header--form-page">
    <nav class="container container--70">
        ...
        <ul>
            ...
            <li><a href="/donations" class="btn btn--without-border">Moje donacje</a></li>
        ...
        <form:form action="home" method="post" modelAttribute="donation">
            ...
            <div data-step="1" class="active">
                ...
                <c:forEach items="${categories}" var="item">
                    <div class="form-group" id="categories">
                        <label>
                            <form:checkbox path="categories" value="${item}" id="cat"/>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        ...
                        <form:input path="quantity" type="number" min="0" id="quantity"/>
                    </label>
                </div>
            ...
            <div data-step="3">
                ...
                <c:forEach items="${institutions}" var="item">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:radiobutton path="institution" value="${item}" id="inst"/>
                ...
                <div class="summary">
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                Ilość worków:<span class="summary--text" id="summaryBag"></span> , zawartość:
                                <span class="summary--text" id="chosenCategories"></span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>Odbiorca:
                                <span class="summary--text" id="chosenInstitution"></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            <h4>Adres odbioru:</h4>
                            <ul>
                                <li id="chosenStreet"></li>
                                <li id="chosenCity"></li>
                                <li id="chosenZipCode"></li>
                                <li>123 456 789</li>
                            </ul>
                        </div>
